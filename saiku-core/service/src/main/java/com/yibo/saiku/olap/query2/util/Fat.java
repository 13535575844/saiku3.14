...
import com.yibo.saiku.query.QueryDetails.Location;
		  ...
		  if (ql == null) {
			...
			if (tl.getSelection() != null) {
			  ...
			  if (StringUtils.isNotBlank(parameter)) {
				...
				ql.setParameterSelectionType(com.yibo.saiku.query.Parameter.SelectionType.INCLUSION);
			  }
...
//					} else {
				...
				ql.setParameterSelectionType(com.yibo.saiku.query.Parameter.SelectionType.EXCLUSION);
//					}
				break;
			  case RANGE:
	...
	private static void extendSortableQuerySet(Query q, ISortableQuerySet qs, ThinSortableQuerySet ts) {
		...
		if (ts.getHierarchizeMode() != null) {
			qs.setHierarchizeMode(com.yibo.saiku.query.ISortableQuerySet.HierarchizeMode.valueOf(ts.getHierarchizeMode().toString()));
		}
		if (ts.getSortOrder() != null) {
			qs.sort(com.yibo.saiku.query.SortOrder.valueOf(ts.getSortOrder().toString()), ts.getSortEvaluationLiteral());
		}
