 ...
 */
package com.yibo.saiku.olap.query;
...
import com.yibo.saiku.olap.query.QueryProperties.QueryProperty;
import com.yibo.saiku.olap.query.QueryProperties.QueryPropertyFactory;
    ...
    public Properties getProperties() {
        ...
        try {
            ...
            if (query.getDimension("Scenario") != null) {
                this.properties.put("com.yibo.saiku.connection.scenario", Boolean.toString(true));
            }
            else {
                this.properties.put("com.yibo.saiku.connection.scenario", Boolean.toString(false));
            }
            this.properties.put("com.yibo.saiku.query.explain", Boolean.toString(connection.isWrapperFor(RolapConnection.class)));
        } catch (Exception e) {
            this.properties.put("com.yibo.saiku.connection.scenario", Boolean.toString(false));
            this.properties.put("com.yibo.saiku.query.explain", Boolean.toString(false));
        }
