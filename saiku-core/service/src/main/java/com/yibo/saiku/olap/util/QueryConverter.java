...
public class QueryConverter {
    ...
    public static SelectNode convert(Query query) throws Exception {
        com.yibo.saiku.query.Query sQuery = convertQuery(query);
        return sQuery.getSelect();
    }

    public static com.yibo.saiku.query.Query convertQuery(Query query) throws Exception {
    ...
    private static void convertAxis(QueryAxis axis, com.yibo.saiku.query.QueryAxis sAxis, com.yibo.saiku.query.Query sQuery) throws Exception {
    ...
    private static void convertDimension(QueryDimension qD, com.yibo.saiku.query.QueryAxis sAxis, com.yibo.saiku.query.Query sQuery) throws Exception {
        boolean first = true;
