...
public class MdxQuery implements IQuery {
  ...
  public Properties getProperties() {
    ...
    props.put("com.yibo.saiku.connection.scenario", Boolean.toString(false));
    try {
      props.put("com.yibo.saiku.query.explain", Boolean.toString(connection.isWrapperFor(RolapConnection.class)));
    } catch (Exception e) {
      props.put("com.yibo.saiku.query.explain", Boolean.toString(false));
    }
    return props;
  }
