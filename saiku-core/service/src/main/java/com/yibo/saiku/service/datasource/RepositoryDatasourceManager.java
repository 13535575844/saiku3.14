...
import com.yibo.saiku.datasources.connection.RepositoryFile;
import com.yibo.saiku.datasources.datasource.SaikuDatasource;
import com.yibo.saiku.repository.*;
import com.yibo.saiku.service.importer.JujuSource;
import com.yibo.saiku.service.importer.LegacyImporter;
import com.yibo.saiku.service.importer.LegacyImporterImpl;
import com.yibo.saiku.service.user.UserService;
import com.yibo.saiku.service.util.security.authentication.PasswordProvider;
...
log.debug("init datadir= "+datadir);
    ...
    public boolean removeSchema(String schemaName) {
        List<com.yibo.saiku.database.dto.MondrianSchema> s = null;
        try {
            s = irm.getAllSchema();
        } catch (RepositoryException e) {
