...
public interface IRepositoryManager {
  ...
  Object saveBinaryInternalFile(InputStream file, String path, String type) throws RepositoryException;
    ...
    List<com.yibo.saiku.database.dto.MondrianSchema> getAllSchema() throws RepositoryException;
    ...
    List<com.yibo.saiku.database.dto.MondrianSchema> getInternalFilesOfFileType(String type) throws RepositoryException;
