...
public interface ISortableQuerySet extends com.yibo.saiku.query.IQuerySet {

	/**
     * Sorts the Hierarchy members by name in the
     * order supplied as a parameter.
     * @param order The {@link com.yibo.saiku.query.SortOrder} to use.
     */
     ...
     * @return A value of {@link com.yibo.saiku.query.SortOrder}
     */
