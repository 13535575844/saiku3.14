...
public class QueryHierarchy extends AbstractSortableQuerySet implements Named {
  ...
  protected com.yibo.saiku.query.QueryAxis axis;
    private final com.yibo.saiku.query.Query query;
	private final Hierarchy hierarchy;
	
	private NamedList<com.yibo.saiku.query.QueryLevel> queryLevels = new NamedListImpl<com.yibo.saiku.query.QueryLevel>();
	
	private NamedList<com.yibo.saiku.query.QueryLevel> activeLevels = new NamedListImpl<com.yibo.saiku.query.QueryLevel>();
	...
	public QueryHierarchy(com.yibo.saiku.query.Query query, Hierarchy hierarchy) {
        super();
        this.query = query;
        this.hierarchy = hierarchy;
        for (Level level : hierarchy.getLevels()) {
            com.yibo.saiku.query.QueryLevel queryLevel = new com.yibo.saiku.query.QueryLevel(this, level);
    ...
    public com.yibo.saiku.query.Query getQuery() {
        return query;
    }

    public com.yibo.saiku.query.QueryAxis getAxis() {
        return axis;
    }
    ...
    public List<com.yibo.saiku.query.QueryLevel> getActiveQueryLevels() {
    	Collections.sort(activeLevels, new SaikuQueryLevelComparator());
    	return activeLevels;
    }
    

    public com.yibo.saiku.query.QueryLevel getActiveLevel(String levelName) {
    	return activeLevels.get(levelName);

    }
    
    public com.yibo.saiku.query.QueryLevel includeLevel(String levelName) {
    	com.yibo.saiku.query.QueryLevel ql = queryLevels.get(levelName);
    	if (ql != null && !activeLevels.contains(ql)) {
    		activeLevels.add(ql);
    	}
    	return ql;
    }
  public com.yibo.saiku.query.QueryLevel includeMemberLevel(String levelName) {
	com.yibo.saiku.query.QueryLevel ql = queryLevels.get(levelName);
	if (ql != null && !activeLevels.contains(ql)) {
	  activeLevels.add(ql);
	}
    ...
    public com.yibo.saiku.query.QueryLevel includeLevel(Level l) throws OlapException {
    	if (!l.getHierarchy().equals(hierarchy)) {
    		throw new OlapException(
    				"You cannot include level " + l.getUniqueName() 
    				+ " on hierarchy " + hierarchy.getUniqueName());
    	}
    	com.yibo.saiku.query.QueryLevel ql = queryLevels.get(l.getName());
    ...
    public void includeCalculatedMember(CalculatedMember m, boolean include) throws OlapException {
		...
		if(include){
		com.yibo.saiku.query.QueryLevel ql = queryLevels.get(m.getLevel().getName());
    ...
    public void clearSelection() {
    	if (activeLevels != null) {
    		for (com.yibo.saiku.query.QueryLevel ql : activeLevels) {
    			ql.clearSelections();
    		}
    	}
    	activeLevels.clear();
	...
	private class SaikuQueryLevelComparator implements Comparator<com.yibo.saiku.query.QueryLevel> {

		@Override
		public int compare(com.yibo.saiku.query.QueryLevel o1, QueryLevel o2) {
			if (o1 != null && o2 != null) {
