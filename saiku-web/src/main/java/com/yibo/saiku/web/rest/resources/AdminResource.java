...
import com.yibo.saiku.database.dto.MondrianSchema;
import com.yibo.saiku.database.dto.SaikuUser;
import com.yibo.saiku.datasources.datasource.SaikuDatasource;
import com.yibo.saiku.log.LogExtractor;
import com.yibo.saiku.service.datasource.DatasourceService;
import com.yibo.saiku.service.datasource.IDatasourceManager;
import com.yibo.saiku.service.importer.JujuSource;
import com.yibo.saiku.service.olap.OlapDiscoverService;
import com.yibo.saiku.service.user.UserService;
import com.yibo.saiku.service.util.exception.SaikuDataSourceException;
import com.yibo.saiku.service.util.exception.SaikuServiceException;
import com.yibo.saiku.web.rest.objects.DataSourceMapper;
...
public class AdminResource {
    ...
    @Path("/datasources/{id}")
    @ReturnType("com.yibo.saiku.web.rest.objects.DataSourceMapper")
    ...
    @Produces( {"application/json"})
    @Path("/users/{id}")
    @ReturnType("com.yibo.saiku.database.dto.SaikuUser")
    ...
    public Response getVersion(){
        ...
        InputStream is = classloader.getResourceAsStream("com/yibo/saiku/web/rest/resources/version.properties");
        try {
